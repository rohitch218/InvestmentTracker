package com.investtracker.transaction.client;
...
public class AuditClient {
    ...
    public void log(AuditRequest request, String tenantId) {
        try {
            log.debug("Sending audit event from Transaction Service for tenant {}: {} on {}", 
            ...
            log.error("Failed to enqueue audit message from Transaction Service: {}", e.getMessage());
        }
    }
}
